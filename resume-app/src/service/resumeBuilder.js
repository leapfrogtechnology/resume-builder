...
export const fetchResume = async (email) => {
  const fetchResumeUrl =
    ...
    urlConstants.fetchResumeUrl.replace(":email", email);
...
export const deleteResume = (data = {}) => {
  const deleteResumeUrl =
    urlConstants.apiBaseUrl + urlConstants.deleteResumeUrl;
...
export const fetchUserProfile = async (email) => {
  const fetchUserProfile =
    urlConstants.apiBaseUrl + urlConstants.fetchUserProfileUrl;
...
export const editResume = async (data, email) => {
  const saveResumeUrl =
    urlConstants.apiBaseUrl +
    urlConstants.editResumeByAdminUrl.replace(":email", email);
