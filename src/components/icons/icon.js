...
export const ADD = (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M12 8V16" stroke="#29B6F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M8 12H16" stroke="#29B6F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
