			...
			<div className="card">
				...
				<div className="personal-info">
					...
					<div className="personal-info-row">
						...
						<div className="personal-info-row__icon"><img src={View} alt="View" /></div>
					</div>
					<div className="personal-info-row">
						<div className="personal-info-row__item">
							<div className="personal-info-row__label">Your Introduction</div>
							<p className="personal-info-row__value">My name is Ribby and I am currently the Engineering Manager at Leapfrog. I love to challenge the normal and help build extraordinary product expeirences.</p>
						</div>
						<div className="personal-info-row__icon"><img src={View} alt="View" /></div>
					</div>
				</div>
